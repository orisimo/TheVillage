...
﻿package com.thevillage
{
	...
	public class GameScreen extends MovieClip
	{
		...
		private function init()
		{
			...
			forest = new Forest(null,null,tileMap.getNewID(), this);
			forest.initBuilding();
			itemsContainer.addChild(forest);
			
			wildlife = new Wildlife(null,null,tileMap.getNewID(), this);
			wildlife.initBuilding();
			itemsContainer.addChild(wildlife);
			
			quarry = new Quarry(null,null,tileMap.getNewID(), this);
			quarry.initBuilding();
