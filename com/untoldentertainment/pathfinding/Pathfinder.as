package com.untoldentertainment.pathfinding 
{
	...
	public class Pathfinder
	{
		...
		public static function findPath( firstNode:INode, destinationNode:INode, connectedNodeFunction:Function ):Array 
		{
			...
			var path:Array = Pathfinder.buildPath(destinationNode, firstNode);
			
			// highlight chosen path in pink?
			/*for(i=0; i<path.length; i++)
			{
				path[i].highlight(0xFF3333);
			}
			
			// highlight destination in red
			Node(destinationNode).highlight(0xFF0000);*/
			return path;
		}
